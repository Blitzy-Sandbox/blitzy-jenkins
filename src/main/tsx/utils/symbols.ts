/**
 * SVG icon string constants used for status indicators and UI controls
 * throughout the Jenkins frontend.
 *
 * These are inline SVG markup strings rendered via innerHTML or dangerouslySetInnerHTML.
 * The SVG content is identical to the original src/main/js/util/symbols.js source.
 *
 * @example
 * import { INFO, SUCCESS, WARNING, ERROR, CLOSE, CHEVRON_DOWN, FUNNEL } from "@/utils/symbols";
 */
