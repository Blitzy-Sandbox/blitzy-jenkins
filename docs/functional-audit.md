...
_This document is maintained as part of the Jenkins core UI migration from Jelly to React 19. Last updated at initial creation — all views pending first Playwright validation pass._
